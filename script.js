...
//   console.log(navLinksArea.children);
//   for (i = 0; i < navLinksArea.children.length - 1; i++) {
//     navLinksArea.children[i].style.opacity = 1;
//   }
// });
...
btnShowmodal.forEach((val) => {
  val.addEventListener("click", modalOpen);
});
